...
class BacktestClient:
    def __init__(self, base_url: str = settings.backtest_service_url):
    ...
    async def request(self, method: str, path: str, request: Request, json: dict[str, Any] | None = None, params: dict[str, Any] | None = None):
        ...
        try:
            ...
            return JSONResponse(status_code=502, content=error_response("BACKTEST_SERVICE_UNAVAILABLE", "Backtest Service 暂不可用", request.state.trace_id).model_dump())
