ROLE_PERMISSIONS = {
    ...
    "risk_manager": ["strategy:read", "signal:read", "signal:manage", "risk:manage", "audit:read", "report:read"],
    "viewer": ["strategy:read", "backtest:read", "ai:read", "market_data:read", "market_state:read", "signal:read", "report:read"],
}
