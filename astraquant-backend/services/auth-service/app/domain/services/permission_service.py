ROLE_PERMISSIONS = {
    ...
    "trader": ["strategy:read", "signal:read", "signal:manage", "paper_trading:read", "paper_trading:manage", "trade:simulate", "trade:approve_live"],
    "risk_manager": ["strategy:read", "signal:read", "risk:read", "risk:manage", "audit:read", "report:read"],
    "viewer": ["strategy:read", "backtest:read", "ai:read", "market_data:read", "market_state:read", "signal:read", "risk:read", "paper_trading:read", "report:read"],
}
